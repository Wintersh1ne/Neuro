...
while True:
    ...
    if event == '-INPUT1-':
        ...
        elif values['-INPUT1-'][0] not in ('-0123456789'):
                g.popup("Only digits allowed")
                window['-INPUT1-'].update(values['-INPUT1-'][1:])
    ...
    if event == '-INPUT2-':
        ...
        elif values['-INPUT2-'][0] not in ('-0123456789'):
                g.popup("Only digits allowed")
                window['-INPUT2-'].update(values['-INPUT2-'][1:])
    ...
    if event == 'Input_1':
        ...
        elif values['Input_1'][0] not in ('-0123456789'):
                g.popup("Only digits allowed")
                window['Input_1'].update(values['Input_1'][1:])
    ...
    if event == 'Input_2':
        ...
        elif values['Input_2'][0] not in ('-0123456789'):
                g.popup("Only digits allowed")
                window['Input_2'].update(values['Input_2'][1:])
